...
\@x{}\moduleLeftDash\@xx{ {\MODULE} NJupiter}\moduleRightDash\@xx{}%
\@x{}%
\@y{%
 ********************** Original \ensuremath{Jupiter} algorithm
 ***********************
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 class \ensuremath{Msg
}}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{\.{\slsl}} type: [\ensuremath{op}, \ensuremath{seq}]
}%
\@xx{}%
\@x{}%
\@y{}%
...
\@x{}%
\@y{\@s{10.0}%
 var \ensuremath{lseq\@s{12.5}\.{\slsl}} local generated msg number
}%
\@xx{}%
\@x{}%
\@y{\@s{10.0}%
 var \ensuremath{gseq\@s{12.5}\.{\slsl}} global received msg number
}%
\@xx{}%
\@x{}%
\@y{\@s{10.0}%
...
\@x{}%
\@y{\@s{42.5}%
 \ensuremath{\.{\slsl} acked} ops: \ensuremath{outgoing[1\.{:}msg.seq\.{-}1]
}}%
\@xx{}%
\@x{}%
\@y{}%
...
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{SendServer([op,\, gseq])
}}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{Append(outgoing,\, [op,\, lseq])
}}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{lseq \.{:=} lseq \.{+} 1
}}%
\@xx{}%
\@x{}%
\@y{}%
...
\@x{}%
\@y{\@s{0}%
 class \ensuremath{ServerThread \.{\slsl}} every client has a corresponding
 server thread
}%
\@xx{}%
\@x{}%
\@y{\@s{10.0}%
 var \ensuremath{lseq \.{\slsl}} symmetrical \ensuremath{Client.gseq} for
 simplicity we keep its name
}%
\@xx{}%
\@x{}%
\@y{\@s{10.0}%
...
\@x{}%
\@y{\@s{10.0}%
 synchronized procedure \ensuremath{SRecv(msg)}:
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 same as \ensuremath{Client.Recv(msg)
}}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{SignalOtherServerThreads(xop)
}}%
\@xx{}%
\@x{}%
\@y{}%
...
\@x{}%
\@y{\@s{10.0}%
 synchronized procedure \ensuremath{Signaled(op)}:
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 same as \ensuremath{Client.Do(op)} except replacing \ensuremath{SendServer}
 to \ensuremath{SendClient
}}%
\@xx{}%
\@pvspace{8.0pt}%
...
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} cbuf ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{cbuf[c]}: locally generated operations at client \ensuremath{c
}}%
\@xx{}%
\@x{\@s{16.4} cseq ,\,\@s{13.79}}%
\@y{\@s{0}%
 \ensuremath{cseq[c]}: number of remote operations received by client
 \ensuremath{c
}}%
\@xx{}%
\@x{\@s{16.4} sbuf ,\,\@s{12.81}}%
\@y{\@s{0}%
 \ensuremath{sbuf[c]}: transformed remote operations \ensuremath{w.r.t}
 client \ensuremath{c
}}%
\@xx{}%
\@x{\@s{16.4} sseq\@s{20.41}}%
\@y{\@s{0}%
 \ensuremath{sseq[c]}: number of locally generated operations by client
 \ensuremath{c
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ vars\@s{7.13} \.{\defeq} {\langle} intVars ,\, cbuf ,\, cseq ,\, sbuf
 ,\, sseq {\rangle}}%
\@pvspace{8.0pt}%
\@x{ NMsg \.{\defeq}}%
 ...
 Nop \} ] \.{\cup}}%
\@y{\@s{0}%
 client \ensuremath{\.{\rightarrow}} server
}%
\@xx{}%
\@x{\@s{16.4} [ seq \.{:} Nat ,\, op \.{:} Op \.{\cup} \{ Nop \} ]}%
\@y{\@s{0}%
 server \ensuremath{\.{\rightarrow}} client
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ TypeOK \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{9.74} TypeOKInt}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} cbuf \.{\in} [ Client \.{\rightarrow} Seq (
 Op \.{\cup} \{ Nop \} ) ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} cseq\@s{1.49} \.{\in} [ Client
 \.{\rightarrow} Nat ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} sbuf\@s{0.51} \.{\in} [ Client
 \.{\rightarrow} Seq ( Op \.{\cup} \{ Nop \} ) ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} sseq\@s{2.00} \.{\in} [ Client
 \.{\rightarrow} Nat ]}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} InitInt}%
 \@x{\@s{16.4} \.{\land} cbuf \.{=} [ c \.{\in} Client \.{\mapsto} {\langle}
 {\rangle} ]}%
 \@x{\@s{16.4} \.{\land} cseq\@s{1.49} \.{=} [ c \.{\in} Client \.{\mapsto} 0
 ]}%
 \@x{\@s{16.4} \.{\land} sbuf\@s{0.51} \.{=} [ c \.{\in} Client \.{\mapsto}
 {\langle} {\rangle} ]}%
 \@x{\@s{16.4} \.{\land} sseq\@s{2.00} \.{=} [ c \.{\in} Client \.{\mapsto} 0
 ]}%
\@x{}\midbar\@xx{}%
\@x{ ClientPerform ( c ,\, m ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\LET} xform \.{\defeq} xFormLocate ( OT ,\, m . op ,\, cbuf
 [ c ] ,\, m . seq )}%
\@y{\@s{0}%
 [\ensuremath{xop}, \ensuremath{xops}]
}%
\@xx{}%
 \@x{\@s{16.4} \.{\IN} \.{\land} cbuf \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c
 ] \.{=} xform . xops ]}%
 \@x{\@s{36.79} \.{\land} cseq \.{'}\@s{1.49} \.{=} [ cseq {\EXCEPT} {\bang} [
 c ]\@s{1.49} \.{=} @ \.{+} 1 ]}%
\@x{\@s{36.79} \.{\land} SetNewAop ( c ,\, xform . xop )}%
\@pvspace{8.0pt}%
\@x{ ServerPerform ( m ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET} c \.{\defeq} m . c}%
 \@x{\@s{36.79} xform \.{\defeq} xFormLocate ( OT ,\, m . op ,\, sbuf [ c ]
 ,\, m . seq )\@s{0.51}}%
\@y{\@s{0}%
 [\ensuremath{xop}, \ensuremath{xops}]
}%
\@xx{}%
\@x{\@s{40.89} xop \.{\defeq} xform . xop}%
 \@x{\@s{16.4} \.{\IN}\@s{4.09} \.{\land} sseq \.{'}\@s{1.49} \.{=} [ sseq
 {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
...
\@x{\@s{40.89} \.{\land} SetNewAop ( Server ,\, xop )}%
 ...
 \.{\mapsto} [ seq \.{\mapsto} sseq [ cl ] ,\, op \.{\mapsto} xop ] ] )}%
\@x{}\midbar\@xx{}%
\@x{ DoOp ( c ,\, op ) \.{\defeq}}%
\@x{\@s{26.06} \.{\land} SetNewAop ( c ,\, op )}%
 \@x{\@s{26.06} \.{\land} cbuf \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ]
 \.{=} Append ( @ ,\, op ) ]}%
 \@x{\@s{26.06} \.{\land} Comm {\bang} CSend ( [ c \.{\mapsto} c ,\, seq
 \.{\mapsto} cseq [ c ] ,\, op \.{\mapsto} op ] )}%
\@pvspace{8.0pt}%
\@x{ Do ( c ) \.{\defeq}}%
\@x{\@s{22.34} \.{\land} DoInt ( DoOp ,\, c )}%
 \@x{\@s{22.34} \.{\land} {\UNCHANGED} {\langle} sbuf ,\, sseq ,\, cseq
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Rev ( c ) \.{\defeq}}%
\@x{\@s{20.94} \.{\land} RevInt ( ClientPerform ,\, c )}%
\@x{\@s{20.94} \.{\land} {\UNCHANGED} {\langle} sbuf ,\, sseq {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SRev \.{\defeq}}%
\@x{\@s{16.4} \.{\land} SRevInt ( ServerPerform )}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} cbuf ,\, cseq {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ Next \.{\defeq}}%
...
\@pvspace{8.0pt}%
\@x{ Fairness \.{\defeq}}%
 \@x{\@s{16.4} {\WF}_{ vars} ( SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev (
 c ) )}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\@s{20.37} Comm {\bang} EmptyChannel \.{\implies} Cardinality ( Range (
 state ) ) \.{=} 1}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 18 16:08:04 \ensuremath{CST} 2019 by \ensuremath{tangruize
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Thu}
 \ensuremath{Jan} 17 10:30:39 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
