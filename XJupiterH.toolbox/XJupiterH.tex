...
\setboolean{shading}{true}
 ...
 {\MODULE} XJupiterH}\moduleRightDash\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} XJupiter ,\,
 TLCUtils}%
...
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} FairnessH \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} {\WF}_{
 varsH} ( SRevH \.{\lor} \E\, c \.{\in} Client \.{:} RevH ( c ) )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 30 21:39:16 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Oct} 10
 15:40:13 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
