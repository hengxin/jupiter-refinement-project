...
\setboolean{shading}{true}
 ...
 {\MODULE} JupiterOid}\moduleRightDash\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} JupiterInterface
 ,\, OT}%
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\VARIABLES}\@s{4.1}}%
\@y{\@s{0}%
 变量
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}}\@s{16.4} cseq\@s{12.29}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} oidVars \.{\defeq} {\langle}
 cseq {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} Oid\@s{1.64} \.{\defeq} [ c
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} Oop \.{\defeq} [ op \.{:} Op
 \.{\cup} \{ Nop \} ,\, oid \.{:} Oid ]}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} OOT ( loop ,\, roop )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{27.70} [ loop {\EXCEPT}
 {\bang} . op \.{=} OT ( loop . op ,\, roop . op ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} xForm ( r ,\, cop )
 \.{\defeq}}%
\@y{\@s{0}%
 Transform \.{\$}cop\.{\$} at replica \.{\$}\ensuremath{r}\.{\$}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} \.{\LET} ctxDiff
 \.{\defeq} ds [ r ] \.{\,\backslash\,} cop . ctx}%
\@y{\@s{0}%
 calculate concurrent operations
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{40.89} xFormHelper ( coph
 ,\, ctxDiffh ,\, xcopssh ) \.{\defeq}}%
\@y{\@s{0}%
 Return transformed \.{\$}\ensuremath{xcop}\.{\$} and
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{57.29} {\IF} ctxDiffh
 \.{=} \{ \} \.{\THEN} [ xcop \.{\mapsto} coph ,\, xcopss \.{\mapsto} xcopssh
 ]}%
\@y{\@s{0}%
 new \.{\$}\ensuremath{copss}\.{\$}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{57.29} \.{\ELSE} \.{\LET}
 foidh\@s{2.59} \.{\defeq} {\CHOOSE} oid \.{\in} ctxDiffh \.{:}}%
\@y{\@s{0}%
 the first \.{\$}\ensuremath{oid}\.{\$} in \.{\$}\ensuremath{ctxDiffh}\.{\$}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{160.92} \A\, id \.{\in}
 ctxDiffh \.{\,\backslash\,} \{ oid \} \.{:} tb ( oid ,\, id ,\, serial [ r ]
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{109.01} fcoph\@s{1.57}
 \.{\defeq} {\CHOOSE} fcop \.{\in} copss [ r ] \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{160.92} fcop . oid \.{=}
 foidh \.{\land} fcop . ctx \.{=} coph . ctx}%
\@y{\@s{0}%
 \ensuremath{CC
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{109.01} xcoph \.{\defeq}
 COT ( coph ,\, fcoph )}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{100.91} xfcoph\@s{5.03}
 \.{\defeq} COT ( fcoph ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{88.61} \.{\IN}\@s{4.1}
 xFormHelper ( xcoph ,\, ctxDiffh \.{\,\backslash\,} \{ fcoph . oid \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{204.92} xcopssh \.{\cup}
 \{ xcoph ,\, xfcoph \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 xFormHelper ( cop ,\, ctxDiff ,\, copss [ r ] \.{\cup} \{ cop \} )}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Jun} 09
 19:04:59 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Feb} 25
 21:32:56 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
