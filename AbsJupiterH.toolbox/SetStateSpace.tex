...
\setboolean{shading}{true}
 ...
 {\MODULE} SetStateSpace}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Set representation of state space, used by \ensuremath{AbsJupiter}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} JupiterCtx}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\RECURSIVE} xForm ( \_ ,\,
 \_ ,\, \_ ,\, \_ )}%
\@y{\@s{0}%
 Transform cop in state space \ensuremath{ss} at replica \ensuremath{r
 \.{\in} Replica}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} xForm ( NextCop ( \_ ,\, \_
 ,\, \_ ,\, \_ ) ,\, r ,\, cop ,\, ss ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} \.{\LET} ctxDiff
 \.{\defeq} ds [ r ] \.{\,\backslash\,} cop . ctx}%
\@y{\@s{0}%
 \ensuremath{{\THEOREM}}: \ensuremath{cop.ctx \.{\subseteq} ds[r]
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{36.79} {\RECURSIVE}
 xFormHelper ( \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{40.89} xFormHelper ( coph
 ,\, ctxDiffh ,\, xss ) \.{\defeq}}%
\@y{\@s{0}%
 Return transformed \ensuremath{xcop
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{57.29} {\IF} ctxDiffh
 \.{=} \{ \} \.{\THEN} [ xcop \.{\mapsto} coph ,\, xss \.{\mapsto} xss ]}%
\@y{\@s{0}%
 and new state space \ensuremath{xss
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{57.29} \.{\ELSE} \.{\LET}
 fcoph\@s{1.57} \.{\defeq} NextCop ( r ,\, coph ,\, ss ,\, ctxDiffh )}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{109.01} xcoph \.{\defeq}
 COT ( coph ,\, fcoph )}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{100.91} xfcoph\@s{5.03}
 \.{\defeq} COT ( fcoph ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{88.61} \.{\IN}\@s{4.1}
 xFormHelper ( xcoph ,\, ctxDiffh \.{\,\backslash\,} \{ fcoph . oid \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{204.92} xss \.{\cup} \{
 xcoph ,\, xfcoph \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 xFormHelper ( cop ,\, ctxDiff ,\, ss \.{\cup} \{ cop \} )}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 05 11:47:39 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Jan} 09
 21:25:30 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
