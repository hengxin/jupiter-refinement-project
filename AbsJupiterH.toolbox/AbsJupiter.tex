...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Abstract \ensuremath{Jupiter}, inspired by the COT algorithm proposed by Sun
 and Sun; see \ensuremath{TPDS\.{'}}2009.
\end{cpar}%
\end{lcom}%
...
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Init \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} \.{\land} InitInt}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\land} InitCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land}
 InitSerial}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} copss
 \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} NextCop ( r ,\, cop ,\, ss
 ,\, ctx ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\LET} foid
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{89.47} \A\, id \.{\in}
 ctx \.{\,\backslash\,} \{ oid \} \.{:} tb ( oid ,\, id ,\, serial [ r ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} \.{\IN} {\CHOOSE}
 fcop \.{\in} ss \.{:}}%
\@y{\@s{0}%
 \ensuremath{{\THEOREM}}: Existence of \ensuremath{fcop
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{53.19} fcop . oid \.{=}
 foid \.{\land} fcop . ctx \.{=} cop . ctx}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} Perform ( r ,\, cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( NextCop ,\, r ,\, cop ,\, copss [ r ] )\@s{4.1}}%
\@y{\@s{0}%
 [\ensuremath{xcop}, \ensuremath{xss}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 copss \.{'} \.{=} [ copss {\EXCEPT} {\bang} [ r ] \.{=} xform . xss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{36.79} \.{\land}
 SetNewAop ( r ,\, xform . xcop . op )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} ClientPerform ( c ,\, cop )
 \.{\defeq} Perform ( c ,\, cop )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\land} Perform (
 Server ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land} Comm
 {\bang} SSendSame ( ClientOf ( cop ) ,\, cop )}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} DoOp ( c ,\, op )\@s{5.43}
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{26.06} \.{\LET} cop
 \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\, seq
 \.{\mapsto} cseq [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{26.06} \.{\IN} \.{\land}
 ClientPerform ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{46.46} \.{\land} Comm
 {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{22.34} \.{\land} DoInt (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{20.94} \.{\land} RevInt (
 ClientPerform ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{20.94} \.{\land}
 RevSerial ( c )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land} SRevInt (
 ServerPerform )}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land}
 SRevSerial}%
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ vars}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} Fairness
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} QC \.{\defeq}}%
\@y{\@s{0}%
 Quiescent Consistency
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{20.37} Comm {\bang}
 EmptyChannel \.{\implies} Cardinality ( Range ( state ) ) \.{=} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} {\THEOREM} Spec \.{\implies}
 {\Box} QC}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} SEC \.{\defeq}}%
\@y{\@s{0}%
 Strong Eventual Consistency
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{21.01} \A\, r1 ,\, r2
 \.{\in} Replica \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{32.33} ds [ r1 ] \.{=} ds
 [ r2 ] \.{\implies} state [ r1 ] \.{=} state [ r2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} {\THEOREM} Spec \.{\implies}
 {\Box} SEC}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}} Compactness \.{\defeq}}%
\@y{\@s{0}%
 Compactness of state space
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{16.4} Comm {\bang}
 EmptyChannel \.{\implies} Cardinality ( Range ( copss ) ) \.{=} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}} {\THEOREM} Spec \.{\implies}
 {\Box} Compactness}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} ClientConstraint \.{\defeq}}%
\@y{\@s{0}%
 Each client generates at most 2 operations.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \forall\, c \.{\in}
 Client \.{:} cseq [ c ] \.{\leq} 3}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 29 09:36:46 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
