...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 and Sun;
 see Sun@\ensuremath{TPDS\.{'}}2009.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\EXTENDS} JupiterSerial ,\,
 SetStateSpace}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} copss\@s{8.2}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} vars \.{\defeq} {\langle}
 intVars ,\, ctxVars ,\, serialVars ,\, copss {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} TypeOK \.{\defeq}}%
...
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land} InitCtx}%
 ...
 InitSerial}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\land} copss
 \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} NextCop ( r ,\, cop ,\, ss
 ,\, ctx ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\LET} foid
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{89.47} \A\, id \.{\in}
 ctx \.{\,\backslash\,} \{ oid \} \.{:} tb ( oid ,\, id ,\, serial [ r ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\IN} {\CHOOSE}
 fcop \.{\in} ss \.{:}}%
\@y{\@s{0}%
 \ensuremath{{\THEOREM}}: Existence of \ensuremath{fcop
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{53.19} fcop . oid \.{=}
 foid \.{\land} fcop . ctx \.{=} cop . ctx}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} Perform ( r ,\, cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( NextCop ,\, r ,\, cop ,\, copss [ r ] )\@s{4.1}}%
\@y{\@s{0}%
 [\ensuremath{xcop}, \ensuremath{xss}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 copss \.{'} \.{=} [ copss {\EXCEPT} {\bang} [ r ] \.{=} xform . xss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{36.79} \.{\land}
 SetNewAop ( r ,\, xform . xcop . op )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} ClientPerform ( c ,\, cop )
 \.{\defeq} Perform ( c ,\, cop )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land} Perform (
 Server ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land} Comm
 {\bang} SSendSame ( ClientOf ( cop ) ,\, cop )}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} DoOp ( c ,\, op )\@s{5.43}
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{26.06} \.{\LET} cop
 \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\, seq
 \.{\mapsto} cseq [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{26.06} \.{\IN} \.{\land}
 ClientPerform ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{46.46} \.{\land} Comm
 {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{22.34} \.{\land} DoInt (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{20.94} \.{\land} RevInt (
 ClientPerform ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{20.94} \.{\land}
 RevSerial ( c )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land} SRevInt (
 ServerPerform )}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\land}
 SRevSerial}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 05 11:05:02 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
