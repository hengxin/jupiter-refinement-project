...
Specification of \ensuremath{Jupiter} with a history variable ``list'',
 upon which we define the weak list specification \ensuremath{WLSpec}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\EXTENDS} Jupiter ,\,
 AdditionalSequenceOperators}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} {\VARIABLES} list}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} VarsH \.{\defeq} {\langle}
 Vars ,\, list {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} TypeOKH \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} \.{\land} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} \.{\land} list
 \.{\subseteq} List}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} InitH \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\land} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} \.{\land} list
 \.{=} \{ InitState \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} DoH ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{25.62} \.{\land} Do ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{25.62} \.{\land} list
 \.{'} \.{=} list \.{\cup} \{ state \.{'} [ c ] \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} RevH ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{25.05} \.{\land} Rev ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{25.05} \.{\land} list
 \.{'} \.{=} list \.{\cup} \{ state \.{'} [ c ] \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} SRevH \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} list
 \.{'} \.{=} list \.{\cup} \{ state \.{'} [ Server ] \}}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} NextH \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} DoH ( c ) \.{\lor} RevH ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\lor} SRevH}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} SpecH \.{\defeq} InitH
 \.{\land} {\Box} [ NextH ]_{ VarsH} \.{\land} {\WF}_{ VarsH} ( NextH )}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} WLSpec \.{\defeq} \A\, l1
 ,\, l2 \.{\in} list \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{62.82} \.{\land}
 Injective ( l1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{62.82} \.{\land}
 Injective ( l2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{62.82} \.{\land}
 Compatible ( l1 ,\, l2 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} {\THEOREM} SpecH
 \.{\implies} WLSpec}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{Last} modified \ensuremath{Tue}
 \ensuremath{Sep} 11 20:12:50 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Sep} 11
 17:34:23 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
