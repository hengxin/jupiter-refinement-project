...
\setboolean{shading}{true}
 ...
 {\MODULE} JupiterCtx}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Definitions for context-based \ensuremath{Jupiter} protocols, including
 \ensuremath{AbsJupiter}, \ensuremath{CJupiter}, and \ensuremath{XJupiter}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} JupiterInterface
 ,\, OT}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} cseq ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{cseq[c]}: local sequence number at client \ensuremath{c \.{\in}
 Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} ds\@s{18.45}}%
\@y{\@s{0}%
 \ensuremath{ds[r]}: document state (\ensuremath{i.e}., a set of
 \ensuremath{Oids}) of replica \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} ctxVars \.{\defeq} {\langle}
 cseq ,\, ds {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} Oid\@s{1.64} \.{\defeq} [ c
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} Oop \.{\defeq} [ op \.{:} Op
 \.{\cup} \{ Nop \} ,\, oid \.{:} Oid ]}%
\@y{\@s{0}%
 operation identified by \ensuremath{oid
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} OOT ( loop ,\, roop )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{OT} of \ensuremath{loop \.{\in} Oop} against \ensuremath{roop
 \.{\in} Oop
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{27.70} [ loop {\EXCEPT}
 {\bang} . op \.{=} OT ( loop . op ,\, roop . op ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} Cop \.{\defeq} [ op \.{:} Op
 \.{\cup} \{ Nop \} ,\, oid \.{:} Oid ,\, ctx \.{:} {\SUBSET} Oid ]}%
\@y{\@s{0}%
 context-based \ensuremath{op
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} ClientOf ( cop ) \.{\defeq}
 cop . oid . c}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} COT ( lcop ,\, rcop )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{OT} of \ensuremath{lcop \.{\in} Cop} against \ensuremath{rcop
 \.{\in} Cop
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{27.19} [ lcop {\EXCEPT}
 {\bang} . op \.{=} OT ( lcop . op ,\, rcop . op ) ,\, {\bang} . ctx \.{=} @
 \.{\cup} \{ rcop . oid \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} UpdateDS ( r ,\, oid )
 \.{\defeq}}%
\@y{\@s{0}%
 update \ensuremath{ds[r]} to include new \ensuremath{oid \.{\in} Oid
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} ds \.{'} \.{=} [ ds
 {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\cup} \{ oid \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} TypeOKCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land} ds
 \.{\in} [ Replica \.{\rightarrow} {\SUBSET} Oid ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} InitCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{=} [ c \.{\in} Client \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land} ds \.{=}
 [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} DoCtx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{'} \.{=} [ cseq {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
 ( c ,\, [ c \.{\mapsto} c ,\, seq \.{\mapsto} cseq [ c ] ] )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{oid} for newly generated operation
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} RevCtx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cseq}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
 ( c ,\, Head ( cincoming [ c ] ) . oid )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} SRevCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cseq}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
 ( Server ,\, Head ( sincoming ) . oid )}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 25 21:26:20 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Dec} 05
 20:03:50 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
