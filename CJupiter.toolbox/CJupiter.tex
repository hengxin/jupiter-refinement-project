...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Specification of our own \ensuremath{CJupiter} protocol; see
 \ensuremath{Wei}@\ensuremath{OPODIS\.{'}}2018.
\end{cpar}%
\end{lcom}%
...
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} css\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{css[r]}: the n-ary ordered state space at replica \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} vars \.{\defeq} {\langle}
 intVars ,\, ctxVars ,\, serialVars ,\, css {\rangle}}%
...
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\land} InitCtx}%
 ...
 InitSerial}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} css \.{=}
 [ r \.{\in} Replica \.{\mapsto} EmptySS ]}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} NextEdge ( r ,\, u ,\, ss )
 \.{\defeq}}%
\@y{\@s{0}%
 Return the first outgoing edge from \ensuremath{u} in \ensuremath{ss} at
 replica \ensuremath{r
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} {\CHOOSE} e \.{\in}
 ss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{32.8} \.{\land} e . from
 \.{=} u}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{32.8} \.{\land} \A\, ue
 \.{\in} ss . edge \.{\,\backslash\,} \{ e \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{52.11} ( ue . from \.{=}
 u ) \.{\implies} tb ( e . cop . oid ,\, ue . cop . oid ,\, serial [ r ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} Perform ( r ,\, cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( NextEdge ,\, r ,\, cop ,\, css [ r ] )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{xform}: [\ensuremath{xcop}, \ensuremath{xss}, lss]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 css \.{'} \.{=} [ css {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\oplus} xform . xss
 ]}%
...
\@pvspace{8.0pt}%
 ...
 {\bang} SSendSame ( ClientOf ( cop ) ,\, cop )\@s{4.1}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} Compactness \.{\defeq}}%
\@y{\@s{0}%
 Compactness of \ensuremath{CJupiter}: the \ensuremath{CSSes} at all replicas
 are the same.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{16.4} Comm {\bang}
 EmptyChannel \.{\implies} Cardinality ( Range ( css ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} {\THEOREM} Spec \.{\implies}
 {\Box} Compactness}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Feb} 02
 12:06:40 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
