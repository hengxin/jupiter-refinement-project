...
\setboolean{shading}{true}
 ...
 {\MODULE} XJupiterImplCJupiter}\moduleRightDash\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS}
 XJupiterExtended\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{XJupiter} extended with \ensuremath{JupiterSerial
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}}\@s{16.4} op2ss ,\,\@s{4.1}}%
\@y{\@s{0}%
 a function mapping an operation (identifier)
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}\@s{51.95}}%
\@y{\@s{0}%
 to the \ensuremath{2D} state space created during it is transformed
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}\@s{16.4} c2ssX\@s{7.70}}%
\@y{\@s{0}%
 \ensuremath{c2ssX[c]}: redundant (\ensuremath{eXtra}) \ensuremath{2D} state
 space maintained for client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} varsImpl \.{\defeq} {\langle}
 varsEx ,\, op2ss ,\, c2ssX {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} TypeOKImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} \.{\land} TypeOKEx}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} \.{\land} \A\, oid
 \.{\in} {\DOMAIN} op2ss \.{:} oid \.{\in} Oid \.{\land} IsSS ( op2ss [ oid ]
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} \.{\land} \A\, c
 \.{\in} Client \.{:} IsSS ( c2ssX [ c ] )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} InitImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} \.{\land} InitEx}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\land}
 op2ss\@s{2.50} \.{=} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} \.{\land} c2ssX
 \.{=} [ c \.{\in} Client \.{\mapsto} EmptySS ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} DoImpl ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} DoEx ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} op2ss ,\, c2ssX {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} RevImpl ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 RevEx ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 \.{\LET} cop \.{\defeq} Head ( cincoming [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{36.71} \.{\IN} c2ssX
 \.{'} \.{=} [ c2ssX {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} op2ss [ cop .
 oid ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 {\UNCHANGED} op2ss}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} SRevImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land} SRevEx}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{56.11} c\@s{1.57}
 \.{\defeq} ClientOf ( cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{35.71} xform\@s{1.16}
 \.{\defeq} xForm ( NextEdge ,\, Server ,\, cop ,\, s2ss [ c ] )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{TODO}: performance\.{!!}!
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{27.51} \.{\IN} op2ss
 \.{'} \.{=} op2ss \.{\,@@\,} cop . oid \.{\colongt} xform . xss}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} c2ssX}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} NextImpl \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} DoImpl ( c ) \.{\lor} RevImpl ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\lor} SRevImpl}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} FairnessImpl \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} {\WF}_{ varsImpl} (
 SRevImpl \.{\lor} \E\, c \.{\in} Client \.{:} RevImpl ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} SpecImpl \.{\defeq} InitImpl
 \.{\land} {\Box} [ NextImpl ]_{ varsImpl}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} FairnessImpl
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} CJ \.{\defeq} {\INSTANCE}
 CJupiter}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{40.89} {\WITH} cincoming
 \.{\leftarrow} cincomingCJ ,\,}%
\@y{\@s{0}%
 \ensuremath{sincoming} needs no substitution
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{71.87} css \.{\leftarrow}
 [ r \.{\in} Replica \.{\mapsto} {\IF} r \.{=} Server}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{170.07} \.{\THEN}
 SetReduce ( \.{\oplus} ,\, Range ( s2ss ) ,\, EmptySS )}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{170.07} \.{\ELSE} c2ss [
 r ] \.{\oplus} c2ssX [ r ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} {\THEOREM} SpecImpl
 \.{\implies} CJ {\bang} Spec}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 29 13:50:03 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Oct} 26
 15:00:19 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
