...
SSend(c, cm) == \* The Server sends a message cm[cl] to client cl (other than c).
...
SSendSameAck(c, mc, mo) == \* The Server sends mc to c and mo to other clients.
    cincoming' = [cl \in Client |-> IF cl = c THEN Append(cincoming[cl], mc)
                                    ELSE Append(cincoming[cl], mo)]
=============================================================================
\* Modification History
\* Last modified Fri Apr 19 17:44:12 CST 2019 by tangruize
