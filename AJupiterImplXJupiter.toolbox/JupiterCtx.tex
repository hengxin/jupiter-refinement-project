...
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} Oid\@s{1.13} \.{\defeq} [ c
 \.{:} Client ,\, seq \.{:} Nat ]\@s{4.1}}%
\@y{\@s{0}%
 operation identifier
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} Cop \.{\defeq} [ op \.{:} Op
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} ClientOf ( cop ) \.{\defeq}
 cop . oid . c}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} COT ( lcop ,\, rcop )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{27.19} [ lcop {\EXCEPT}
 {\bang} . op \.{=} OT ( lcop . op ,\, rcop . op ) ,\, {\bang} . ctx \.{=} @
 \.{\cup} \{ rcop . oid \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} UpdateDS ( r ,\, oid )
 \.{\defeq}}%
\@y{\@s{0}%
 update \ensuremath{ds[r]} to include new \ensuremath{oid \.{\in} Oid
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} ds \.{'} \.{=} [ ds
 {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\cup} \{ oid \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} TypeOKCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\land} ds
 \.{\in} [ Replica \.{\rightarrow} {\SUBSET} Oid ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} InitCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{=} [ c \.{\in} Client \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} ds \.{=}
 [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} DoCtx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{'} \.{=} [ cseq {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} RevCtx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cseq}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
 ( c ,\, Head ( cincoming [ c ] ) . oid )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} SRevCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cseq}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
 ( Server ,\, Head ( sincoming ) . oid )}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 21:13:06 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
